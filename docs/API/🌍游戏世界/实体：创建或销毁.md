...
#### 事件**world.**onEntityCreate(handler:(event:GameEntityEvent)=>void) : [GameEventHandlerToken](https://www.yuque.com/box3lab/api/gll7mhwasgn9hoq0)
**当实体被创建时触发**
...
#### 事件**world.**onEntityDestroy(handler:(event:GameEntityEvent)=>void) : [GameEventHandlerToken](https://www.yuque.com/box3lab/api/gll7mhwasgn9hoq0)
**当实体被销毁时触发**
