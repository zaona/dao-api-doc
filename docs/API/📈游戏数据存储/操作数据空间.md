...
#### **storage.set**(key**:string,**value:[JSONValue](#TzBdh)) **: **Promise<void>
...
| value | _是_ | 
 ...
 | [JSONValue](#TzBdh) | 需要设置的值 |


---


#### **storage.get**(key**:string**) **: **Promise<[ReturnValue](#Y6PLL)>
**获取指定键对应的值。**
...
| **类型** | **说明** |
| --- | --- |
| [ReturnValue](#Y6PLL) | 异步返回数据，当获取完成时 resolve，否则 reject。 |


---


#### **storage.update**(key**:string,**handler:(prevValue:[ReturnValue](#Y6PLL))=>[JSONValue](#TzBdh)) **: **Promise<void>
**更新指定键对应的值。**
...
| handler | _是_ | 
 ...
 | function | 处理更新的方法，接受一个参数，为当前键的值，返回一个更新后的值 |


---


#### **storage.remove**(key**:string**) **: **Promise<[ReturnValue](#Y6PLL)>
**删除指定键值对。**
...
| **类型** | **说明** |
| --- | --- |
| [ReturnValue](#Y6PLL) | 异步返回数据，当删除完成时 resolve，否则 reject。 |
...
| options | _是_ | 
 ...
 | Partial<[ListPageOptions](#wFvkb)> | 批量获取键值对的配置项 |
...
| getCurrentPage() | ()=>[ReturnValue](#Y6PLL)[] | 按 {QueryList &#124; pageSize} 获取当前页的键值对，返回当前页的键值对内容 |
