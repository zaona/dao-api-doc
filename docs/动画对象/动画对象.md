...
| playback | 否 | 
 ...
 | Partial<[GameAnimationPlaybackConfig](#lhaax)> | 播放的参数 |
...
#### 事件**onFinish**(handler:(event:[GameAnimationEvent](#anWjP))=>void) : [GameEventHandlerToken](https://www.yuque.com/box3lab/api/gll7mhwasgn9hoq0/edit)
**当动画结束播放时触发**
...
| **参数** | **类型** | **说明** |
| --- | --- | --- |
| animation | [GameAnimation](#anWjP) | 动画对象 |
